...
################################################################################
# USAGE If you are using this file as your ~/.zshrc file, please use ~/.zshrc.pre
...
function command_not_found_handler () {
    ...
    if [[ -x ${GRML_ZSH_CNF_HANDLER} ]] ; then
        ${GRML_ZSH_CNF_HANDLER} --no-failure-msg -- $1
    fi
    return 1
}
...
LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/usr/local/lib:/home/paja/VulkanSDK/1.1.85.0/x86_64/lib
...
alias mydotfiles='git --git-dir=/home/paja/.dotfiles/ --work-tree=/home/paja'
